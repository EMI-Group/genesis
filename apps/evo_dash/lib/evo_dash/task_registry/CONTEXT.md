...
| `EvoDash.TaskRegistry.Cleanup` | `cleanup.ex` | Task history expiry — age/count-based cleanup of finished tasks |
...
- Internal helpers (`handle_update_status`, store reads, `normalize_tasks`, `reconcile_task_status`, `resolve_recheck_task`, `trim_recent_projects`)
