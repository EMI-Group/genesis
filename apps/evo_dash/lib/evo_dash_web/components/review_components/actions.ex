      ...
      <div class="flex flex-wrap gap-3">
        <%= if @branch_exists do %>
          <button
            ...
            disabled={@loading}
          >
            <.icon name="hero-check" class="size-4.5" /> {gettext("Merge Changes")}
          </button>
          ...
          <button
            ...
            disabled={@loading}
          >
            <.icon name="hero-x-mark" class="size-4.5" /> {gettext("Reject Changes")}
          </button>
          ...
          <button
            ...
            disabled={@loading}
          >
            <.icon name="hero-arrow-path" class="size-4.5" /> {gettext("Continue from Here")}
          </button>
        ...
        <%= if @branch_exists and not @has_pr do %>
          <button
            ...
            disabled={@loading}
          >
            <.icon name="hero-arrow-top-right-on-square" class="size-4.5" /> {gettext(
              "Create GitHub PR"
            )}
          </button>
        <% end %>
        ...
        <%= if @branch_exists do %>
          ...
          <button
            ...
            disabled={@loading}
          >
            <.icon name="hero-academic-cap" class="size-4.5" /> {gettext("Extract Skills")}
          </button>
        <% end %>
        ...
        <button
          ...
          disabled={@loading}
        >
          <.icon name="hero-eye-slash" class="size-4.5" /> {gettext("Ignore")}
        </button>
      </div>
    </div>
    """
