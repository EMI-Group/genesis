          ...
          <div class="flex-1 min-w-0">
            ...
            <div class="flex flex-wrap items-center gap-2 mt-2">
              <span class={["badge badge-sm px-2 py-1.5", review_status_badge(@status)]}>
                <.icon name={review_status_icon(@status)} class="size-3.5 mr-1.5" /> {review_status_label(
                  @status
                )}
              </span>
              ...
              <%= if @branch_name do %>
                <span class="badge badge-sm badge-primary px-2 py-1.5 font-mono">
                  <.icon name="hero-code-bracket-square" class="size-3.5 mr-1.5" /> {@branch_name}
                </span>
              <% end %>
      ...
      <%= if @usage do %>
        ...
        <details class="mt-3">
          <summary class="cursor-pointer text-xs font-medium text-base-content/60 hover:text-base-content flex items-center gap-1.5 select-none outline-none py-1 w-fit">
            <.icon name="hero-currency-dollar" class="size-3.5 text-primary" /> {gettext(
              "Token & Cost Usage"
      ...
      <div class="relative">
        ...
        <div class="absolute top-3 right-3 z-10 flex items-center gap-1">
          <div class="flex gap-0">
            ...
            >
              <.icon name="hero-document-text" class="size-3.5" /> {gettext("Markdown")}
            </button>
            ...
            >
              <.icon name="hero-code-bracket" class="size-3.5" /> {gettext("Raw")}
            </button>
          </div>
