  ...
  def render(assigns) do
    ...
    <EvoDashWeb.Layouts.app flash={@flash} current_page={:help} config_status={@config_status}>
      <div class="h-full overflow-y-auto scroll-region">
        <div class="px-4 lg:px-6 py-4 lg:py-6 space-y-4">
            ...
            <div class="bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-4 sm:p-6">
              <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div class="flex gap-2">
                  <%= if @editing do %>
                    <button class="btn btn-sm btn-ghost press-scale" phx-click="cancel_edit">
                      <.icon name="hero-x-mark" class="size-4" /> Cancel
                    </button>
                    <button class="btn btn-sm btn-primary press-scale" phx-click="save_config">
                      <.icon name="hero-check" class="size-4" /> Save
                    </button>
                  <% else %>
                    <button class="btn btn-sm btn-primary press-scale" phx-click="edit_config">
