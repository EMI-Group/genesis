defmodule EvoDashWeb.AgentsLive.FileTree do
  ...
  # Note: "assets" is NOT skipped — it holds real frontend sources in many
  # projects (Phoenix included). Dot-dirs are rejected wholesale below.
  @skip_dirs ~w(.git .genesis node_modules deps _build .elixir_ls)
  @max_depth 6
  @max_dirs 800
