defmodule EvoDashWeb.TasksLive do
  ...
  def render(assigns) do
    ~H"""
    <div id="tasks-root" class="h-screen flex flex-col bg-base-100 text-base-content">
      <PadComponents.pad_top_bar current={:tasks} review_count={@review_count} />
            ...
            <%= if @filtered_tasks == [] do %>
              <div class="text-center py-12 sm:py-16 text-base-content/50">
                ...
                <p class="text-sm mt-1">
                  ...
                  <% else %>
                    {gettext("Tasks will appear here once you start them from the home page.")}
                  <% end %>
                </p>
              </div>
            <% else %>
