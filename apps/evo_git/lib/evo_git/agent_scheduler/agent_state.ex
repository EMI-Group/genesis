defmodule EvoGit.AgentScheduler.AgentState do
  ...
  - `repo_root` — the main repo path this agent belongs to (not the worktree path)
  - `foreign_repos` — list of additional repo paths this agent's subagents can reference
  ...
  defstruct [:context, :context_node, :phylo_node, :repo_root, :event_sink, :llm_model, :max_retries, :max_depth, :parent_id, :objective, foreign_repos: []]
