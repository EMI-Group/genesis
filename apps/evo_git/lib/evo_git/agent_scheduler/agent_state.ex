defmodule EvoGit.AgentScheduler.AgentState do
  ...
  defstruct [:context, :context_node, :phylo_node, :event_sink, :llm_model, :max_retries, :max_depth, :parent_id, :objective, :task_local_id, repo_id: :primary, repo_root: nil, timeout_ms: 1_800_000]
