...
| Module | Description |
|---|---|
| `EvoGit` | Sandboxing utilities (`sandbox_args/4`), safe shell command execution |
...
| `./lib/evo_git/agents/` | Agent implementations (Generalist, Manager, Executor, Planner, Investigator, Architect, Extractor, Evaluator) |
